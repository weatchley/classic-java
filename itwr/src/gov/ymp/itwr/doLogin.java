    ...
    try {
        ...
        if (command.equals("login")) {
            ...
            if (validated) {
                ...
                ALog.logActivity(user.getID(), acronym, 7,"User " + user.getFirstName() + ' ' + user.getLastName() + " logged in.");


            } else {
                ALog.logActivity(0, acronym, 7,"Failed login attempt on username " + un);
            }
            outLine = "";
