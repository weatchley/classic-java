...
//System.out.println("Got Here 1" +"- command: " + command + " id: " + id + " PageID: " + pageName);
        ...
        if (command.equals("update")) {
            ...
            success = true;
            outLine = "";
            ALog.logActivity(userID, "itwr", 2, ti.getID() + "/\"" + ti.getText() + "\" updated");
        // Request approval via e-mail and set the status to approvalrequested
            ...
            success = true;
            outLine = "";
            ALog.logActivity(userID, "itwr", 2, ti.getID() + "/\"" + ti.getText() + "\" approval requested");
        // Approve update, set the status to approved and copy approved working content to the published content
            ...
            success = true;
            outLine = "";
            ALog.logActivity(userID, "itwr", 2, ti.getID() + "/\"" + ti.getText() + "\" updated/approved");
