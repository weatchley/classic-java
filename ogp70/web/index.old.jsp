					...
					<td width="40%" class=ppanel>
						<table cellpadding="5" cellspacing="0" width="100%">
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="" style="display:none;">
											<tr>
												<td width="20" class=tl></td>
												<td class=pbgt>
												From Director
							...
							<tr>
								<td>
										<table style="display:none;" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="">
											<tr>
												<td width="20" class=tl></td>
												<td class=pbgt>
												News Feeds
