...
function showDebug(bShow) {
 if (debugWindow == null) {
  ...
  top.debug("Debug window initialized.");
  top.debug("Comment out ''showDebug();' in /index.jsp to disable the function.");
  top.debug("Usage: top.debug('text to be output to the window');");
 }
