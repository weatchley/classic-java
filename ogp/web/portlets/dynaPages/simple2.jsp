...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <!--tr bgcolor="#006699"> 
    <td height="79" background="images/topbkgd.gif" width="1%"><img src="images/topleftskinny.jpg" width="140" height="80"></td>
  ...
  <tr bgcolor="#006699"> 
    <td colspan="2" height="79" background="images/topbkgd.gif"><img src="images/topleftskinny.jpg" width="140" height="80" border=0></td>
...
<!-- Start Top Nav bar contents ************************************************************************************************ -->  
 ...
 <tr> 
    ...
    <a href="https://ocrwmgateway.ocrwm.doe.gov/ocrwmgateway" target="_blank"><font color="#CC9900">OCRWM Gateway</font></a>&nbsp;<font color="#CC9900">-</font>&nbsp;
    <a class="topnav" href="http://www.energy.gov/" target="_blank">Energy.gov</a>&nbsp;-&nbsp;
 ...
 <!-- End Top Nav bar contents ************************************************************************************************ -->
  <tr>	
  		<td valign=top>
		<%--  side navigation section begins --%>  		
				<table width="150" border="0" cellspacing="1" cellpadding="3" >
						  <tr>
						  	<td colspan=2><img src="images/menu.gif" width="150" height="15"></td>
						  </td>
				</table>
				<table width="150" border="0" cellspacing="1" cellpadding="3" bgcolor="#CCCCCC">
						  <tr>
						    ...
						    <td width="123" bgcolor="#FFFFFF"><a class="leftnav" href="index.jsp?pagehash=OGP-PageContent-OTM">OTM Home</a></td>
						  </tr>
						  <tr>
						    <td width="27" bgcolor="#FFFFFF" valign=top><img src="images/seta.gif" width="7" height="9" align="right"></td>
						    <td width="123" bgcolor="#FFFFFF"><a class="leftnav" href="index.jsp?pagehash=OGP-PageContent-OCS">Science Division</a></td>
						  </tr>
						  <!--tr>
						    <td width="27" bgcolor="#FFFFFF" valign=top><img src="images/seta.gif" width="7" height="9" align="right"></td>
						  ...
						  <tr>
						    <td width="27" bgcolor="#FFFFFF" valign=top><img src="images/seta.gif" width="7" height="9" align="right"></td>
						    <td width="123" bgcolor="#FFFFFF"><p><a class="leftnav" href="index.jsp?pagehash=OGP-PageContent-RAO">Regulatory Affairs Division</a></p></td>
						  </tr>
						<!-- Menu optons that only show up if not logged in -->
						  <tr>
						    <td width="27" bgcolor="#FFFFFF" valign=top><img src="images/seta.gif" width="7" height="9" align="right"></td>
						    <td width="123" bgcolor="#FFFFFF"><p><a class="leftnav" href="index.jsp?pagehash=OGP-PageContent-OCE">Engineering Division</a></p></td>
						  </tr>
				</table>
		<%--  side navigation content section ends --%>  		
  		</td>
  		<td>&nbsp;</td>
  		<td>
