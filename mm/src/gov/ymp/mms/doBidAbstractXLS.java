...
public class doBidAbstractXLS extends HttpServlet {
  ...
  private String processRequest(HttpServletRequest request, HttpServletResponse response) {
    ...
    String pr = ((request.getParameter("id")  != null) ? (String) request.getParameter("id") : "NVNO20070096");

    String reportTitle = "Price Quote Worksheet";
...
//System.out.println("doBidAbstractXLS - " + "Got Here 1 prnumber: " + pr);

        PurchaseDocument pd = new PurchaseDocument(pr, myConn);
        PurchaseDocument pdHist = new PurchaseDocument(pr, myConn, true, 4);
        Bid [] bids = Bid.getItemList(myConn, pr);
        User buyer = new User(pd.buyer, myConn);

//System.out.println("doBidAbstractXLS - " + "Got Here 2 - bid count: " + bids.length + ", bid item count: " + bids[0].items.length + ", pr items count: " + pd.items.length);

        String [] rIDs = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z",
...
// Set up report title (span multiple columns
        ...
        sheet.addMergedRegion(new Region(rowNumb,(short)0,rowNumb,(short)(5)));
...
//-
// Set up secondary report title (span multiple columns
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        sheet.addMergedRegion(new Region(rowNumb,(short)0,rowNumb,(short)(5)));
        cell = row.createCell((short)(++cellNumb));
        cell.setCellValue("Title");
        cell.setCellStyle( (HSSFCellStyle) csm.get("csBoldCenter24") );
        cell = row.createCell(++cellNumb);
        cell.setCellValue(" ");
        cell.setCellStyle( (HSSFCellStyle) csm.get("csBoldCenter24") );
        cell = row.createCell(++cellNumb);
        ...
        cell.setCellValue(" ");
        cell.setCellStyle( (HSSFCellStyle) csm.get("csBoldCenter24") );
        row.setHeight( (short) (((HSSFFont) fontSet.get("fBold24")).getFontHeight() + 100) );
...
//- header row 1
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, "Task:", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, pd.chargeNumber, (HSSFCellStyle) csm.get("csLightYellow"));
        cell = generateCell(row, ++cellNumb, "Quote #:", (HSSFCellStyle) csm.get("csRight"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB2"));
//- header row 2
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, "Ref #: ", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, ((pd.refnumber != null) ? pd.refnumber : ""), (HSSFCellStyle) csm.get("cs"));
        cell = generateCell(row, ++cellNumb, "Date:", (HSSFCellStyle) csm.get("csRight"));
        cell = generateCell(row, ++cellNumb, Utils.dateToString(new java.util.Date()), (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB2"));
//- header row 3
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, "To:", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "EES POC:", (HSSFCellStyle) csm.get("csRight"));
        cell = generateCell(row, ++cellNumb, buyer.fullName, (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB2"));
//- header row 4
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, "Phone:", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "Phone:", (HSSFCellStyle) csm.get("csRight"));
        cell = generateCell(row, ++cellNumb, "(" + buyer.areacode + ") " + buyer.phonenumber.substring(0, 3) + "-" + buyer.phonenumber.substring(3) + ((buyer.extension != null) ? " ext: " + buyer.extension : ""), (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB2"));
//- header row 5
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, "Fax:", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "Fax:", (HSSFCellStyle) csm.get("csRight"));
        cell = generateCell(row, ++cellNumb, "(702) 794-5447", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB2"));
//- header row 6
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, "Email:", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "Loc:", (HSSFCellStyle) csm.get("csRight"));
        cell = generateCell(row, ++cellNumb, buyer.location, (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB2"));
//- header row 7
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csRight"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB2"));
        for (int i=0; i<(bids.length + 1); i++) {
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB3"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB3"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB3"));
        }
...
// Do main body headers 1
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, "Payment Terms: " + pd.paymentTerms, (HSSFCellStyle) csm.get("csItalicCenter"));
        cell = generateCell(row, ++cellNumb, "Part", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, "Unit", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, "Extended", (HSSFCellStyle) csm.get("csCenterB2"));

        int tableWidth = 6 + (bids.length * 2);
        int winningBid = -1;
        // loop through bidders
        for (int i=0; i<bids.length; i++) {
            cell = row.createCell(++cellNumb);
            ++cellNumb;
            sheet.addMergedRegion(new Region(rowNumb,(short)(cellNumb - 1),rowNumb,(short)(++cellNumb)));
            cell.setCellValue(bids[i].vendor.name);
            cell.setCellStyle( ((i%2 == 1)  ? (HSSFCellStyle) csm.get("csCenterLT") : (HSSFCellStyle) csm.get("csCenterY")) );
            if (pd.vendorID == bids[i].vendorID) { winningBid = i; }
        }
        cell = generateCell(row, ++cellNumb, "Customer", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "Customer", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "Customer", (HSSFCellStyle) csm.get("csCenter"));

        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csRightB"));

// Do main body headers 2
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, "Item", (HSSFCellStyle) csm.get("csCenterB3"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenterB3"));
        cell = generateCell(row, ++cellNumb, "Number", (HSSFCellStyle) csm.get("csCenterB3"));
        cell = generateCell(row, ++cellNumb, "Qty", (HSSFCellStyle) csm.get("csCenterB3"));
        cell = generateCell(row, ++cellNumb, "Price", (HSSFCellStyle) csm.get("csCenterB3"));
        cell = generateCell(row, ++cellNumb, "Price", (HSSFCellStyle) csm.get("csCenterB3"));
        // loop through bidders
        for (int i=0; i<bids.length; i++) {
            cell = generateCell(row, ++cellNumb, "Ven #" + (i+1) + " Qty", ((i%2 == 1)  ? (HSSFCellStyle) csm.get("csCenterLT") : (HSSFCellStyle) csm.get("csCenterY")));
            cell = generateCell(row, ++cellNumb, "Vendor #" + (i+1) + " Price", ((i%2 == 1)  ? (HSSFCellStyle) csm.get("csCenterLT") : (HSSFCellStyle) csm.get("csCenterY")));
            cell = generateCell(row, ++cellNumb, "Ven #" + (i+1) + " Total", ((i%2 == 1)  ? (HSSFCellStyle) csm.get("csCenterLT") : (HSSFCellStyle) csm.get("csCenterY")));
        }
        cell = generateCell(row, ++cellNumb, "Qty", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "Price", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "Ext Price", (HSSFCellStyle) csm.get("csCenter"));
...
// main table values
        ...
        for (int i=0; i<pd.items.length; i++) {
            ...
            int rowID = rowNumb + 1;
            // Info from PO
            cell = generateCell(row, ++cellNumb, pd.items[i].itemNumber, (HSSFCellStyle) csm.get("csCenterB"));
            String temp = pd.items[i].description.replaceAll("(\t|\f|\b|\r|\n$)", "");
            cell = generateCell(row, ++cellNumb, temp, (HSSFCellStyle) csm.get("csB"));
            cell = generateCell(row, ++cellNumb, ((pd.items[i].partNumber != null) ? pd.items[i].partNumber : ""), (HSSFCellStyle) csm.get("csB"));
            cell = generateCell(row, ++cellNumb, pd.items[i].quantity, (HSSFCellStyle) csm.get("csCenterB"));
            cell = generateCell(row, ++cellNumb, pd.items[i].unitPrice, (HSSFCellStyle) csm.get("csDollarB"));
            cell = generateCellFormula(row, ++cellNumb, "d" + rowID + "*" + rIDs[cellNumb - 1] + rowID, (HSSFCellStyle) csm.get("csDollarB"));

// Bid info
            // loop through bidders
            for (int j=0; j<bids.length; j++) {
                cell = generateCell(row, ++cellNumb, ((i < bids[j].items.length) ? bids[j].items[i].quantity : 0), ((j%2 == 1)  ? (HSSFCellStyle) csm.get("csCenterLT") : (HSSFCellStyle) csm.get("csCenterY")));
                cell = generateCell(row, ++cellNumb, ((i < bids[j].items.length) ? bids[j].items[i].unitPrice : 0), ((j%2 == 1)  ? (HSSFCellStyle) csm.get("csDollarLT") : (HSSFCellStyle) csm.get("csDollarY")));
                cell = generateCellFormula(row, ++cellNumb, rIDs[cellNumb - 2] + rowID + "*" + rIDs[cellNumb - 1] + rowID, ((j%2 == 1)  ? (HSSFCellStyle) csm.get("csDollarLT") : (HSSFCellStyle) csm.get("csDollarY")));
            }
            // Info from originally approved (historic) PR
            cell = generateCell(row, ++cellNumb, ((i<pdHist.items.length) ? pdHist.items[i].quantity : 0), (HSSFCellStyle) csm.get("csCenter"));
            cell = generateCell(row, ++cellNumb, ((i<pdHist.items.length) ? pdHist.items[i].unitPrice : 0), (HSSFCellStyle) csm.get("csDollar"));
            cell = generateCellFormula(row, ++cellNumb, rIDs[cellNumb - 2] + rowID + "*" + rIDs[cellNumb - 1] + rowID, (HSSFCellStyle) csm.get("csDollar"));
...
// shipping
        row = sheet.createRow(++rowNumb);
        int lastRowNumber = rowNumb + 1;
        cellNumb = -1;
        // Info from PO
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenterB"));
        cell = generateCell(row, ++cellNumb, "Shipping Charges", (HSSFCellStyle) csm.get("csB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenterB"));
        cell = generateCell(row, ++cellNumb, 1, (HSSFCellStyle) csm.get("csCenterB"));
        cell = generateCell(row, ++cellNumb, pd.shipping, (HSSFCellStyle) csm.get("csDollarB"));
        cell = generateCellFormula(row, ++cellNumb, "d" + lastRowNumber + "*" + rIDs[cellNumb - 1] + lastRowNumber, (HSSFCellStyle) csm.get("csDollarB"));
        // loop through bidders
        for (int i=0; i<bids.length; i++) {
            cell = generateCell(row, ++cellNumb, 1, ((i%2 == 1)  ? (HSSFCellStyle) csm.get("csCenterLT") : (HSSFCellStyle) csm.get("csCenterY")));
            cell = generateCell(row, ++cellNumb, bids[i].shipping, ((i%2 == 1)  ? (HSSFCellStyle) csm.get("csDollarLT") : (HSSFCellStyle) csm.get("csDollarY")));
            cell = generateCellFormula(row, ++cellNumb, rIDs[cellNumb - 2] + lastRowNumber + "*" + rIDs[cellNumb - 1] + lastRowNumber, ((i%2 == 1)  ? (HSSFCellStyle) csm.get("csDollarLT") : (HSSFCellStyle) csm.get("csDollarY")));
        }
        // Info from originally approved (historic) PR
        cell = generateCell(row, ++cellNumb, 1, (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, pdHist.shipping, (HSSFCellStyle) csm.get("csDollar"));
        cell = generateCellFormula(row, ++cellNumb, rIDs[cellNumb - 2] + lastRowNumber + "*" + rIDs[cellNumb - 1] + lastRowNumber, (HSSFCellStyle) csm.get("csDollar"));
...
// sub totals
        ...
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "Sub-Total", (HSSFCellStyle) csm.get("csBoldCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenterB"));
        cell = generateCellFormula(row, ++cellNumb, "sum(f" + firstRowNumber + ":f" + lastRowNumber + ")", (HSSFCellStyle) csm.get("csDollarB"));
        // loop through bidders
        for (int i=0; i<bids.length; i++) {
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csDollarLightGreen"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csDollarLightGreen"));
            cell = generateCellFormula(row, ++cellNumb, "sum(" + rIDs[cellNumb]  + firstRowNumber + ":" + rIDs[cellNumb] + lastRowNumber + ")", (HSSFCellStyle) csm.get("csDollarLightGreen"));
        }
        // Info from originally approved (historic) PR
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csDollarLightGreen"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csDollarLightGreen"));
...
//  - Info and fees for HQ
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, "Proposed Vendor:", (HSSFCellStyle) csm.get("cs"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
        cell = generateCell(row, ++cellNumb, "EES Admin Fee 2%", (HSSFCellStyle) csm.get("csItalicCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenterB"));
        cell = generateCellFormula(row, ++cellNumb, "f" + rowNumb + "*0.02", (HSSFCellStyle) csm.get("csDollarB"));
        for (int i=0; i<(bids.length + 1); i++) {
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
        }
...
//  - Info and fees for HQ
        ...
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, pd.vendor.name, (HSSFCellStyle) csm.get("csLightYellow"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
        cell = generateCell(row, ++cellNumb, "EES Total", (HSSFCellStyle) csm.get("csBoldCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB"));
        cell = generateCellFormula(row, ++cellNumb, "sum(f" + (rowNumb - 1) + ":f" + rowNumb + ")", (HSSFCellStyle) csm.get("csDollarBold"));
        // loop through bidders
        for (int i=0; i<(bids.length+1); i++) {
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
        ...
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csRightB"));
//  - Spacers & bid remarks title
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, "Bid Remarks: ", (HSSFCellStyle) csm.get("cs"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB"));
...
//  - Info and fees for HQ
        row = sheet.createRow(++rowNumb);
        short justRowNumb = rowNumb;
        HSSFRow justRow = row;
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csRightB"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
        cell = generateCell(row, ++cellNumb, "OCIO contract\nAdmin Fee 1%", (HSSFCellStyle) csm.get("csBoldCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB"));
        cell = generateCellFormula(row, ++cellNumb, "f" + (rowNumb - 1) + "*0.01", (HSSFCellStyle) csm.get("csDollarBold"));
        // loop through bidders
        for (int i=0; i<(bids.length+1); i++) {
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("cs"));
...
// tax
        ...
        if (pd.vendor.hasTaxID[pd.site] && pd.taxExempt.equals("F")) {
            showTax = true;
            row = sheet.createRow(++rowNumb);
            lastRowNumber = rowNumb + 1;
            cellNumb = -1;
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
            cell = generateCell(row, ++cellNumb, "Tax", (HSSFCellStyle) csm.get("csBoldCenter"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenterB"));
            cell = generateCell(row, ++cellNumb, pd.tax, (HSSFCellStyle) csm.get("csDollarB"));
            // loop through bidders
            for (int i=0; i<bids.length; i++) {
                cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
                cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csCenter"));
...
//  - Grand total
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB4"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB3"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB3"));
        cell = generateCell(row, ++cellNumb, "Grand Total", (HSSFCellStyle) csm.get("csBoldCenter"));
        cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB"));
        cell = generateCellFormula(row, ++cellNumb, "sum(f" + (rowNumb - ((showTax) ? 3 : 2)) + ":f" + (rowNumb) + ")", (HSSFCellStyle) csm.get("csDollarBold"));
        // loop through bidders
        for (int i=0; i<(bids.length+1); i++) {
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB3"));
            cell = generateCell(row, ++cellNumb, " ", (HSSFCellStyle) csm.get("csB3"));
...
// add bid remarks
        sheet.addMergedRegion(new Region(justRowNumb,(short)1,justRowNumb+2,(short)(2)));
        cell = generateCell(justRow, (short)1, pd.bidRemarks, (HSSFCellStyle) csm.get("cs"));
...
//  - Signature lines
        ...
        ++rowNumb;
        row = sheet.createRow(++rowNumb);
        cell = generateCell(row, cellNumb, "Purchasing Specialist", (HSSFCellStyle) csm.get("csB5"));
        ++rowNumb;
        ++rowNumb;
        ++rowNumb;
        row = sheet.createRow(++rowNumb);
        cell = generateCell(row, cellNumb, "ITSS Project Manager", (HSSFCellStyle) csm.get("csB5"));
...
// size columns to fit content
  ...
  private void generateResponse(String outLine, String command, HttpServletResponse response)
    ...
    out.println("<title>MMS Bid Abstract/Price Quote Worksheet</title>");
    out.println("</head>");
