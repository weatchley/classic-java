<%
	...
	String bgImgURL = "../graphics/bg2.gif";
...
.clWindow {
	Z-INDEX: 15; LEFT: 1px; OVERFLOW: hidden; WIDTH: 250px; TOP: 14px; BACKGROUND-COLOR: white; 
/*	
...
.clWinResize {
	...
	BACKGROUND-COLOR: transparent;
	/*
	BACKGROUND-IMAGE: url(/images/resize.gif); layer-background-image: url(/images/resize.gif);
	*/
}
.clWinTabContainer {
	Z-INDEX: 30; WIDTH: 565px;  HEIGHT: 18px; CLIP: rect(0px 565px 18px 0px);
	BACKGROUND-COLOR: transparent;
}
.clWinTabTbl {
	 height:18px; border-color:<%=winBorderColor%>; font-size:10px; font-family:Arial, Helvetica, sans-serif;BACKGROUND-COLOR:transparent;text-align::center; color:<%=winFontColor%>;border-right-width:1px;border-right-color:<%=winBorderColor%>;border-right-style:solid;
...
*/
.sBox1 {
    font-family: verdana,Geneva, Arial, Sans-serif; font-size: 12px; color:#3c6076 ; background-color: #e8f5ff;
...
.sBox2 {
	color:#666600;font-family: verdana,Geneva, Arial, Sans-serif; font-size: 12px; border: #000000; border-style:hidden; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;width:150px; background-color:#ECD553;
	/*
	display:none;
	*/
	display:block;
...
.sBox3 {
	color:#D7FFFF;font-family: verdana,Geneva, Arial, Sans-serif; font-size: 12px; border: #000000; border-style:hidden; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;width:150px; background-color:#73B9B9;
	/*
	display:none;
	*/
	display:block;
...
.nText {
	FONT-WEIGHT:lighter; FONT-SIZE: 11px; COLOR:#4e6790; LEFT: 10px; TOP: 0px; HEIGHT: 14px; WIDTH: 200px;  BACKGROUND-COLOR: transparent; 
}