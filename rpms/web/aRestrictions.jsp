...
ARestriction [] list = ARestriction.getItemList(myConn);
...
<script language="javascript">
  ...
  <h3>Access Restriction Management Page</h3><br>
...
//System.out.println(".jsp - Got Here 1" + " command: " + command);
    ...
    if (dispCount == 0) {
        %>
        <tr><td>No Access Restrictions Available</td></tr>
        <%
    }
    %></table><%
}
...
<script language=javascript><!--
    ...
    function doNew() {
        ...
        submitForm("aRestrictions.jsp","new");
    }
    ...
    function doSave() {
        ...
        if (msg != '') {
            ...
            submitFormResults("doARestriction",<%= ((command.equals("new")) ? "'add'" : "'update'") %>);
        }
    }
    ...
    function doDrop(id) {
        ...
        if (confirm('Delete Access Restriction "' + message + '"?')) {
            submitFormResults("doARestriction","drop");
        }
    }
...
<input type=hidden name=nextscript value="aRestrictions.jsp">
<table border=0>
