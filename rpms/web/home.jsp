...
<script language=javascript><!--
    ...
    function doSave() {
        if (isblank(document.main.text.value)) {
            ...
            submitFormResults("doHomePage",'update');
        }
    }
    
    function doRequestApproval() {
        //alert('Not Ready Yet');
        submitFormResults("doHomePage","approvalrequest")
    }
    
    function doApprove() {
        submitFormResults("doHomePage","approve")
    }
...
<input type=hidden name=homepagename value="<%= pageName %>">
