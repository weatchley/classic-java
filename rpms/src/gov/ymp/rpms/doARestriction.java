...
public class doARestriction extends HttpServlet {
...
//    inputstring = (inputstring != null && inputstring.compareTo(" ") > 0) ? inputstring : "";
    ...
    try {
        ...
        if (command.equals("add")) {
            ARestriction item = new ARestriction();
//System.out.println("Got Here 1" +"- command: " + command + ", code: " + code + ", Description: " + description);
            ...
            success = true;
            outLine = "";
            ALog.logActivity(userID, "rpms", 1, "ARestriction " + item.getCode() + "/\"" + HtmlUtils.getDisplayString(item.getDescription(), 100) + "\" added");

        } else if (command.equals("update")) {
            ARestriction item = new ARestriction(code, myConn);
            item.setDescription(description);
            item.save(myConn, userID);
            success = true;
            outLine = "";
        ...
        ALog.logError(userID, "csi", 0, "ARestriction error: '" + outLine + "'");
	    //log(outLine);
    }
