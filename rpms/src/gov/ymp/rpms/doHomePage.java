...
public class doHomePage extends HttpServlet {
...
//System.out.println("Got Here 1" +"- command: " + command + " id: " + id + " NewsletterID: " + homePageName);
        ...
        UHash pageContent = new UHash(homePageName, myConn);
        ...
        // Request approval via e-mail and set the status to approvalrequested
            ...
            message += "An approval has been requested for the RPMS homepage, please review at:\n";
            ...
            mb.setSubject("RPMS-Home page approval request");
            mb.setBody(message);
