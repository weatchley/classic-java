...
public class doNewsletter extends HttpServlet {
  ...
  private String processRequest(HttpServletRequest request, HttpServletResponse response) {
    ...
    String newsletterName = request.getParameter("newslettername");
    UHash newsletter = null;
    String outLine = "";
...
//System.out.println("Got Here 1" +"- command: " + command + " id: " + id + " NewsletterID: " + newsletterName);
        ...
        if (command.equals("add")) {
            ...
            success = true;
            outLine = "";
            newsletter = new UHash(newsletterName, myConn);
        ...
        // Request approval via e-mail and set the status to approvalrequested
            ...
            TextItem ti = new TextItem(Long.parseLong(id), myConn);
            Permission perm = new Permission (myConn, 7, "appnewsletter");
            ...
            message += "An approval has been requested for newsletter: " + Utils.dateToString(ti.getDate1()) + ", please review at:\n";
            ServletContext ctx = getServletContext();
            message += "    " + request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + "/" + ctx.getServletContextName() + "/newsletter.jsp\n";
            mb.setFrom("intranetwebmaster@ymp.gov");
            mb.setSubject("RPMS-Newsletter approval request");
            mb.setBody(message);
        ...
        ALog.logError(userID, "csi", 0, "Newsletter error: '" + outLine + "'");
	    //log(outLine);
    }
  ...
  private void generateResponse(String outLine, String command, String nextScript, boolean success, HttpServletResponse response)
    ...
    if (success) {
        ...
        out.println("alert('Error processing newsletter!');\n");
    }
    out.println("//-->\n");
    out.println("</script>\n");
    out.println("");
