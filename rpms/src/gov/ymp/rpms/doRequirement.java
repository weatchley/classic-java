...
public class doRequirement extends HttpServlet {
...
//System.out.println("Got Here 1" +"- command: " + command + " id: " + id + ", Description: " + item.getDescription());
            ...
            success = true;
            outLine = "";
            ALog.logActivity(userID, "rpms", 1, "Requirement " + item.getID() + "/\"" + HtmlUtils.getDisplayString(item.getDescription(), 100) + "\" added");

        } else if (command.equals("update")) {
            Requirement item = new Requirement(Integer.parseInt(id), myConn);
            item.setDescription(description);
            item.save(myConn, userID);
            success = true;
            outLine = "";
            ...
            success = true;
            outLine = "Requirement " + temp + " Removed";
        ...
        ALog.logError(userID, "csi", 0, "Requirement error: '" + outLine + "'");
	    //log(outLine);
    }
  ...
  private void generateResponse(String outLine, String command, String nextScript, boolean success, HttpServletResponse response)
    ...
    out.println("<title>Requirement</title>");
    out.println("</head>");
