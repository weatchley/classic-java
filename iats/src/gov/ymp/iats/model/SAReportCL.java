...
public class SAReportCL {
	...
	public SAReportCL() throws IOException, 
	StronglyTypedPropertiesSet.IncompletePropertyFileException
    {
		//_props = new SAReportCLProperties();
    }
	
	public SAReportCL(int orgid, int year, DbConn myConn) throws IOException, 
	StronglyTypedPropertiesSet.IncompletePropertyFileException
    {
		System.out.println("SAReportCLTest created with orgID: "+orgid+", year: "+year);
		init();
