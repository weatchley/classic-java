...
/**
* Organization is the class to hold all attributes for POrganization object  
*
...
public class Organization {
    ...
    */
    ...
    //public ResultSet getlist(DbConn myConn){
	    ...
	    sqlcode = "SELECT id, name, acronym, isactive FROM " + SCHEMAPATH + ".ORGANIZATION " + wherestring + orderby;
