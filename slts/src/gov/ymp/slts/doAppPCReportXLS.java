...
public class doAppPCReportXLS extends HttpServlet {
...
//System.out.println("doAppPCReportXLS - " + "Got Here 1 prnumber: " + pr);
...
// Do main body headers 1
        row = sheet.createRow(++rowNumb);
        cellNumb = -1;
        cell = generateCell(row, ++cellNumb, "ID", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, "Name", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, "Domain", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, "Manufacturer", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, "Model", (HSSFCellStyle) csm.get("csCenterB2"));
        cell = generateCell(row, ++cellNumb, "Product Name", (HSSFCellStyle) csm.get("csCenterB2"));
...
// main table values
        ...
        for (int i=0; i<items.length; i++) {
            ...
            int rowID = rowNumb + 1;
            // Info from PO
            cell = generateCell(row, ++cellNumb, items[i].getComputerID(), (HSSFCellStyle) csm.get("csCenterB"));
            cell = generateCell(row, ++cellNumb, items[i].getName(), (HSSFCellStyle) csm.get("csB"));
            cell = generateCell(row, ++cellNumb, items[i].getDomainName(), (HSSFCellStyle) csm.get("csB"));
            cell = generateCell(row, ++cellNumb, items[i].getManuf(), (HSSFCellStyle) csm.get("csB"));
            cell = generateCell(row, ++cellNumb, ((items[i].getModelNum() != null) ? items[i].getModelNum() : " "), (HSSFCellStyle) csm.get("csB"));
            cell = generateCell(row, ++cellNumb, items[i].getProdName(), (HSSFCellStyle) csm.get("csB"));
...
// Add list of selected applications
        ...
        row = sheet.createRow(++rowNumb);
        sheet.addMergedRegion(new Region(rowNumb,(short)0,rowNumb,(short)(5)));
        cell = generateCell(row, (short) 0, "Selected Applications", (HSSFCellStyle) csm.get("csBold2"));
        for (int i=0; i<appList.length; i++) {
            row = sheet.createRow(++rowNumb);
            sheet.addMergedRegion(new Region(rowNumb,(short)0,rowNumb,(short)(5)));
            cell = generateCell(row, (short) 0, appList[i], (HSSFCellStyle) csm.get("cs2"));
        }
